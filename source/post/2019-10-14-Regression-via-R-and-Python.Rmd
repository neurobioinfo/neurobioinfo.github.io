...
car_data=read.csv2("https://raw.githubusercontent.com/neurobioinfo/neurobioinfo.github.io/master/public/data/cardata.csv")
names(car_data)
head(car_data)
```
...
```{python, echo = TRUE}
import pandas as pd
car_data = pd.read_csv("https://raw.githubusercontent.com/neurobioinfo/neurobioinfo.github.io/master/public/data/cardata.csv", delimiter=";", decimal=",")
car_data.columns
car_data.head(10)
```
