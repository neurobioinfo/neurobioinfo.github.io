...
Here we present a scRNA-seq workflow based on Seurat’s scRNAseq workflow for multiplexed samples [6]. This workflow aims to scale the one dataset analysis to an automatedc and reproducable analysis for a large number of scRNAseq datasets.
...
1. Armand EJ, Li J, Xie F, Luo C, Mukamel EA. (2021) Single-Cell Sequencing of Brain Cell Transcriptomes and Epigenomes. Neuron [Internet]. 109, 11–26. Available from: https://pubmed.ncbi.nlm.nih.gov/33412093
2. See P, Lum J, Chen J, Ginhoux F. (2018) A Single-Cell Sequencing Guide for Immunologists. Front Immunol [Internet]. 9, 2425–2425. Available from: https://pubmed.ncbi.nlm.nih.gov/30405621
3. Wang W, Wang L, She J, Zhu J. (2021) Examining heterogeneity of stromal cells in tumor microenvironment based on pan-cancer single-cell RNA sequencing data. Cancer Biol Med [Internet]. 19, 30–42. Available from: https://pubmed.ncbi.nlm.nih.gov/34398535
4. Ma S-X, Lim SB. (2021) Single-Cell RNA Sequencing in Parkinson’s Disease. Biomedicines [Internet]. 9. Available from: https://www.mdpi.com/2227-9059/9/4/368
5. Stoeckius M, Zheng S, Houck-Loomis B, Hao S, Yeung BZ, Mauck WM, et al. (2018) Cell Hashing with barcoded antibodies enables multiplexing and doublet detection for single cell genomics. Genome Biology [Internet]. 19, 224. Available from: https://doi.org/10.1186/s13059-018-1603-1
6. Satija R, Farrell JA, Gennert D, Schier AF, Regev A. (2015) Spatial reconstruction of single-cell gene expression data. Nature Biotechnology [Internet]. 33, 495–502. Available from: https://doi.org/10.1038/nbt.3192
[7]	10X Genomic. Cell Ranger [Internet]. What is cellplex. Available from: https://support.10xgenomics.com/single-cell-gene-expression/software/pipelines/latest/what-is-cellplex
